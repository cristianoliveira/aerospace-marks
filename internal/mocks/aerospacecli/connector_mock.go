...
// Source: pkgs/aerospacecli/connector.go
//
// Generated by this command:
//
//	mockgen -source=pkgs/aerospacecli/connector.go -destination=internal/mocks/aerospacecli/connector_mock.go -package=aerospacecli_mock
//
